...
const toogleDropdown = () => (state.dropDownOpen = !state.dropDownOpen);
</script>
<template>
    <div class="sticky top-0 z-40">
        ...
        <!-- dropdown menu -->
        <div
            class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 top-18 right-0 mr-6"
            :class="state.dropDownOpen ? '' : 'hidden'"
        >
